...
class ChatControllerTest {
    ...
    @Test
    void suggestTitles() {
        MvcTestResult testResult = mockMvcTester.post().uri("/api/chat/suggest-titles")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {
    ...
    @Test
    void getLanguages() {
        MvcTestResult testResult = mockMvcTester.get().uri("/api/chat/langs")
                .exchange();
        assertThat(testResult)
                .hasStatus(HttpStatus.OK)
                .bodyJson()
    ...
    @Test
    void generateTweet() {
        MvcTestResult testResult = mockMvcTester.post().uri("/api/chat/gen-tweet")
                .contentType(MediaType.APPLICATION_JSON)
                .content("""
                        {
